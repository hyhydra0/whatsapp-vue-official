        ...
        <div class="wa-left-side">
          <div class="wa-content">
            ...
            <div v-if="loginMode === 'qr'" class="wa-instructions">
              ...
              <ol class="wa-steps">
                <li v-html="localizedText.qrStep1"></li>
                <li v-html="localizedText.qrStep2"></li>
                <li v-html="localizedText.qrStep3"></li>
                <li v-html="localizedText.qrStep4"></li>
              </ol>
              <!-- Toggle link -->
            ...
            <div v-else class="wa-phone-content">
                ...
                <div v-if="phoneStep === 1" class="wa-phone-form">
                          ...
                          <div v-for="country in filteredCountries" :key="country.code" class="wa-country-item"
                            ...
                            <div v-if="country.code === selectedCountry" class="wa-country-checkmark">
                              <svg width="16" height="16" viewBox="0 0 16 16">
                                <path d="M13.5 4.5L6 12L2.5 8.5" stroke="#00a884" stroke-width="2"
                  ...
                  <!-- Next Button -->
                  <button class="wa-next-button" :disabled="!phoneNumber || submitting"
                  ...
                  <div class="wa-code-instructions">
                    <div class="wa-instruction-item">
                      ...
                      <span class="wa-instruction-text">
                        {{ localizedText.codeInstruction1 }} <span class="wa-emoji"><svg viewBox="0 0 40 40" height="24" width="24"
                            preserveAspectRatio="xMidYMid meet" class="x1i5p2am x1whfx0g xr2y4jy x1ihp6rs" fill="none">
                    ...
                    <div class="wa-instruction-item">
                      ...
                      <div class="wa-instruction-text">
                        <div style="display: flex;"><span>{{ localizedText.codeInstruction2Android }} &nbsp;</span><span class="wa-emoji-icon"><svg viewBox="0 0 24 24" height="20" width="18"
                        ...
                        <div style="display: flex;"><span>{{ localizedText.codeInstruction2iPhone }} &nbsp;</span>
                          <span class="wa-emoji-icon"><svg viewBox="0 0 20 20"
                            height="18" width="18" preserveAspectRatio="xMidYMid meet" class="x1ks1olk x1hql6x6"
                            fill="none">
