...
const permissionModules = [
  { name: 'dashboard', label: 'Dashboard & Analytics' },
  { name: 'analytics', label: '数据分析' },
  { name: 'admin_user_management', label: '后管用户管理' },
  { name: 'rbac', label: '角色权限管理' },
  { name: 'whatsapp_account', label: 'WhatsApp账号' },
  { name: 'whatsapp_user', label: 'WhatsApp用户' },
  { name: 'device', label: '设备管理' },
  { name: 'message', label: '消息管理' },
  { name: 'tag', label: '标签管理' },
  { name: 'translation', label: '翻译功能' },
  { name: 'language', label: '语言配置' },
  { name: 'monitor', label: '监控功能' },
