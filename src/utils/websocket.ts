...
class WebSocketClient {
  ...
  connect(accountId: number) {
    ...
    console.log('[WebSocket Debug] VITE_WS_BASE_URL:', wsBaseUrl)
    console.log('[WebSocket Debug] VITE_API_BASE_URL:', import.meta.env.VITE_API_BASE_URL)

    // 如果没有设置独立的 WebSocket URL，则从 API 基础 URL 推导
    if (!wsBaseUrl) {
      ...
      console.log('[WebSocket Debug] 推导的 wsBaseUrl:', wsBaseUrl)
    }
